...
const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyEITACizwEX9VYX7bKFvaPfbf1fmd22ynaEzO06BVg8udhVemrlkX9AEb0iH-i_01DfQ/exec"; // Paste your deployed Apps Script URL here
...
async function buildPDF(opts) {
  ...
  // QR code
  if (qrDataUrl) {
    try { doc.addImage(qrDataUrl,"PNG",W-margin-28,54,26,26); } catch(e){}
    doc.setFontSize(6); doc.setFont("helvetica","normal"); doc.setTextColor(191,219,254);
    doc.text("Scan to verify",W-margin-24,82);
  }
  ...
  // Inspector
  var iy=by+bh+6;
  doc.setFillColor(239,246,255); doc.roundedRect(margin,iy,W-margin*2,18,4,4,"F");
  doc.setFontSize(7); doc.setFont("helvetica","bold"); doc.setTextColor(100,116,139);
  doc.text("INSPECTOR",margin+6,iy+7);
  doc.setFontSize(9); doc.setFont("helvetica","bold"); doc.setTextColor(15,23,42);
  doc.text(inspectorName,margin+6,iy+14);
  doc.setFontSize(8); doc.setFont("helvetica","normal"); doc.setTextColor(71,85,105);
  doc.text(inspectorEmail,margin+6+doc.getTextWidth(inspectorName)+4,iy+14);
...
function App(){
  ...
  var capturePhoto=useCallback(async function(slotId,file){
    ...
    reader.onload=async function(e){
      ...
      setPhotos(function(p){var n=Object.assign({},p);n[slotId]={url:stamped,ts:ts,gps:photoGps,placeName:photoPlace};return n;});
  ...
  if(screen===SCREEN.DONE) return React.createElement("div",{style:S.page},
    React.createElement("div",{style:S.center},
      React.createElement("div",{style:S.centerCard},
        ...
        placeName&&React.createElement("div",{style:S.locationBox},"[GPS] "+placeName),
          ...
          ? React.createElement("div",null,
              React.createElement("div",{style:S.officeValidated},
                React.createElement("div",null,
                  ...
                  React.createElement("div",{style:{fontSize:11,color:"#64748b",marginTop:2}},office.email)
                ),
                React.createElement("button",{
                  style:S.changeBtn,
                  onClick:function(){
