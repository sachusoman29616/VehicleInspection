...
function App(){
  ...
  async function openCamera(slotId){
    ...
    setCamOpen(true);
    // Small delay to let state update and DOM render
  ...
  async function startCamera(facing){
    ...
    try {
      var constraints={video:{facingMode:{ideal:facing},width:{ideal:1280},height:{ideal:720}}};
      ...
      }catch(e2){alert("Camera not available: "+e2.message);setCamOpen(false);}
    }
  }
