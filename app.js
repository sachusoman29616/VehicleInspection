...
function App(){
  ...
  async function handleSubmit(){
    ...
    try{
      ...
      // Small wait for gmailUser state to update
      ...
      var doc=await buildPDF({
        ...
        inspectorName:currentUser.name||"Inspector", inspectorEmail:currentUser.email,
      ...
      // Get latest user info safely
      var currentUser = gmailUser;
      if(!currentUser||!currentUser.email){
        try{ currentUser=JSON.parse(localStorage.getItem("ui_user")||"null"); }catch(e){}
      }
      if(!currentUser||!currentUser.email){
        setError("Could not get inspector details. Please try again.");
      ...
      var bodyLines=[
        ...
        "Inspector  : "+(currentUser.name||"Inspector")+" <"+currentUser.email+">",
